        ...
        <SignUpContentWrapper>
          ...
          <SignUpForm>
            ...
            <FormBox>
              ...
              <FormInput
                placeholder="통신사 선택"
                onClick={selectMobileOpen}
                value={telecomInputValue}
                onChange={(e) => setTelecomInputValue(e.target.value)}
              ></FormInput>
            </FormBox>
            <FormBox>
              <FormTitle>
              ...
              <FormInput placeholder="01012345678" type="text"></FormInput>
            </FormBox>
          </SignUpForm>
      ...
      {mobileModalOpen && (
        <ModalWrapper>
          <ModalContentWrapper onClick={(e) => e.stopPropagation()}>
            ...
            <ModalSelectWrapper>
              <ModalSelect onClick={() => handleTelecomSelect("SKT")}>
                SKT
              </ModalSelect>
              <ModalSelect onClick={() => handleTelecomSelect("KT")}>
                KT
              </ModalSelect>
              <ModalSelect onClick={() => handleTelecomSelect("LG U+")}>
                LG U+
              </ModalSelect>
              <ModalSelect onClick={() => handleTelecomSelect("SKT 알뜰폰")}>
                SKT 알뜰폰
              </ModalSelect>
              <ModalSelect onClick={() => handleTelecomSelect("KT 알뜰폰")}>
                KT 알뜰폰
              </ModalSelect>
              <ModalSelect onClick={() => handleTelecomSelect("LG U+ 알뜰폰")}>
                LG U+ 알뜰폰
              </ModalSelect>
            </ModalSelectWrapper>
          </ModalContentWrapper>
          ...
          <ModalContentWrapper onClick={(e) => e.stopPropagation()}>
            ...
            <ModalSelectWrapper>
              <ModalSelectBox>
                ...
                <span>
                  <ModalSelect>전체 동의하기</ModalSelect>
                </span>
              </ModalSelectBox>
              <ModalSelectBox>
                <span>
              ...
              <ModalSelectBox>
                <span>
                  <CircleBtn
                    style={{ marginLeft: "95px", marginTop: "8px" }}
                    type="checkbox"
                    name="personal"
                    onChange={check}
                    checked={checkList.includes("personal") ? true : false}
                  ></CircleBtn>
                </span>
                <span>
                  <ModalSelect>
              ...
              <ModalSelectBox>
                <span>
                  <CircleBtn
                    ...
                    name="identity"
                    onChange={check}
                    checked={checkList.includes("identity") ? true : false}
                  ></CircleBtn>
                </span>
                <span>
                  <ModalSelect>[필수] 고유식별정보처리 동의</ModalSelect>
                </span>
              </ModalSelectBox>
              <ModalSelectBox>
                <span>
                  <CircleBtn
                    ...
                    name="mobile"
                    onChange={check}
                    checked={checkList.includes("mobile") ? true : false}
                  ></CircleBtn>
                </span>
                <span>
                  <ModalSelect>[필수] 통신사 시용약관</ModalSelect>
                </span>
              </ModalSelectBox>
            </ModalSelectWrapper>
            <AgreeBtn
